<nav class="flex flex-col w-64 h-screen bg-white border-r border-gray-200">
    <!-- Logo/Title -->
    ...
    <ul class="flex-1 px-2 py-4 space-y-1 overflow-y-auto">
        ...
        <li>
            <a href="{{ route('pos.index') }}" class="flex items-center px-4 py-2.5 rounded-lg transition-all duration-200 {{ request()->routeIs('pos.index') ? 'bg-blue-50 text-blue-600 font-medium' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <li>
            <a href="#" class="flex items-center px-4 py-2.5 rounded-lg transition-all duration-200 text-gray-600 hover:bg-gray-50 hover:text-gray-900">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <div class="px-4 py-4 border-t border-gray-200">
        <div class="flex items-center">
            <div class="flex-shrink-0">
                <img class="h-9 w-9 rounded-full" src="https://via.placeholder.com/40" alt="User">
            </div>
            <div class="ml-3">
